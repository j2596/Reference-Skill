...
16. Each final citation has a recorded chapter/section location or stable paragraph location in `引用对应核验说明.md`.
17. Each final citation records the original text snippet, the revised final paper sentence, the PDF evidence sentence, and the support relationship.
18. If the original text did not directly match the PDF evidence, the paper body was rewritten or supplemented so the citation is genuine.
19. The final response includes all required file paths and processing counts.
